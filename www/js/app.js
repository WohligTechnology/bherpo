...
.filter('serverimage', function() {
    ...
    .filter('sponsorimage', function() {
        return function(image) {
            if (image && image != null) {
                return "img/sponsor/" + image;
            } else {
                return "img/default.png";
            }
        };
...
.directive('youtube', function($sce) {
    return {
        ...
        replace: true,
        template: '<iframe id="popup-youtube-player" style="overflow:hidden;height:100%;width:100%" width="100%" height="100%" src="{{url}}" frameborder="0" allowscriptaccess="always" allowfullscreen="allowfullscreen" mozallowfullscreen="mozallowfullscreen" msallowfullscreen="msallowfullscreen" oallowfullscreen="oallowfullscreen" webkitallowfullscreen="webkitallowfullscreen"></iframe>',
        link: function(scope) {
